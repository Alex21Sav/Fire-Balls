...
public class TowerBuilder : MonoBehaviour
{
    ...
    {
        return new Vector3(_buildPoint.position.x, currentSegment.position.y + currentSegment.localScale.y / _step + _block.transform.localScale.y / _step, _buildPoint.position.z); 
    }
}
